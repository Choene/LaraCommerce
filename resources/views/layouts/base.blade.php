			...
			<div class="main-footer-content">
				...
				<div class="container">
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">45 Palm Central Checkers Polokwane,LP 0709 South Africa ZA</p>
											</li>
											<li>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">We Using Safe & Secure Payments:</h3>
								<div class="item-content">
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Ke Tlala Ka Nna. All rights reserved</p>
					</div>
